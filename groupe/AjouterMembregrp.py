...
"color: rgb(252, 252, 252);")
    ...
    def ajout_groupe(self):
            ...
            query_insert = "INSERT INTO groupes (sport,age_min,age_max,poids_min,poids_max,sexe) VALUES (%s, %s,  %s,%s,%s,%s)"
            values = (sport,age_min,age_max,poids_min,poids_max,sexe)
