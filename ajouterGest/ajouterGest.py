...
class Ui_MainWindowAjouterGest(object):
    def setupUi(self, MainWindowAjouterGest):
        MainWindowAjouterGest.setObjectName("MainWindowAjouterGest")
        MainWindowAjouterGest.resize(1060, 780)
        MainWindowAjouterGest.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(MainWindowAjouterGest)
...
"color: rgb(252, 252, 252);")
        ...
        MainWindowAjouterGest.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindowAjouterGest)
        QtCore.QMetaObject.connectSlotsByName(MainWindowAjouterGest)

    def retranslateUi(self, MainWindowAjouterGest):
        _translate = QtCore.QCoreApplication.translate
        MainWindowAjouterGest.setWindowTitle(_translate("MainWindowAjouterGest", "MainWindow"))
        self.label.setText(_translate("MainWindowAjouterGest", "Ajouter un Gestionnaire"))
        self.lineEditNom.setPlaceholderText(_translate("MainWindowAjouterGest", " Nom"))
        self.lineEditPrenom.setPlaceholderText(_translate("MainWindowAjouterGest", " Prénom"))
        self.lineEditNumtlph.setPlaceholderText(_translate("MainWindowAjouterGest", "   Numero de téléphone"))
        self.lineEditEmail.setPlaceholderText(_translate("MainWindowAjouterGest", " E-mail"))
        self.lineEditNomUti.setPlaceholderText(_translate("MainWindowAjouterGest", "Nom d\'Utilisateur"))
        self.lineEditMDP.setPlaceholderText(_translate("MainWindowAjouterGest", "Mot de passe"))
        self.pushButtonSave.setText(_translate("MainWindowAjouterGest", "Enregistrer"))
        self.pushButtonAnnuler.setText(_translate("MainWindowAjouterGest", "Annuler"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MainWindowAjouterGest = QtWidgets.QMainWindow()
    ui = Ui_MainWindowAjouterGest()
    ui.setupUi(MainWindowAjouterGest)
    MainWindowAjouterGest.show()
    sys.exit(app.exec_())
