...
# Form implementation generated from reading ui file 'ajouterOffre.ui'
...
class Ui_ajouterAbonnement(object):
    ...
    def setupUi(self, ajouterAbonnement):
        ...
        ajouterAbonnement.resize(672, 638)
...
"color: rgb(252, 252, 252);")
        ...
        self.pushButtonSave.clicked.connect(self.add_offre)
    ...
    def retranslateUi(self, ajouterAbonnement):
        ...
        self.label.setText(_translate("ajouterAbonnement", "Ajouter un Offre"))
        self.Id.setText(_translate("ajouterAbonnement", "NOM"))
        self.lineEditID.setPlaceholderText(_translate("ajouterAbonnement", " NOM"))
        ...
        self.DateDebut.setText(_translate("ajouterAbonnement", "Durée"))
        self.lineEditDateDebut.setPlaceholderText(_translate("ajouterAbonnement", "Durée"))
        self.DateFin.setText(_translate("ajouterAbonnement", "Prix"))
        self.lineEditDateFin.setPlaceholderText(_translate("ajouterAbonnement", "Prix"))
        self.Offre.setText(_translate("ajouterAbonnement", "Nombre de Séances"))
        self.lineEdit.setPlaceholderText(_translate("ajouterAbonnement", "Nombre de Séances"))
        ...
        self.dropdownSport.addItem('Karate')
        self.dropdownSport.addItem('Judo')
        self.dropdownSport.addItem('Kick boxing')
        self.dropdownSport.addItem('Fitness homme')
        self.dropdownSport.addItem('Fitness femme')
        self.dropdownSport.addItem('Self defence')

    def add_offre(self):
        name = self.lineEditID.text()
        sport = self.dropdownSport.currentText()
        self.lineEditDateDebut.setText("1 mois")
        Prix = self.lineEditDateFin.text()
        self.lineEditID.setText("4 séances")
        if sport == "choisir" or name == "" or Prix == "":
            self.msg = QtWidgets.QMessageBox()
            self.msg.setIcon(QtWidgets.QMessageBox.Critical)
            self.msg.setText("Veuillez remplir Les Champs Obligatoires")
            self.msg.setWindowTitle("Erreur")
            self.msg.exec_()
        elif self.insertDb(name,sport,Prix):
            self.msg = QtWidgets.QMessageBox()
    ...
    def insertDb(self, nom,sport,prix):
        connection, cursor = connect_to_DB()
        cursor.execute("SELECT MAX(ID_offre) FROM offre")
        last_id = cursor.fetchone()[0]
        new_id = last_id + 1
        query = "INSERT INTO offre (ID_offre, NOM_offre, sport, prix) VALUES (%s, %s, %s, %s)"
        values = (new_id, nom,sport,prix)
        cursor.execute(query, values)
        connection.commit()
        cursor.close()
        return True

from ajoffre import ajouterOffre_rc
