...
"border-radius:5px;")
    ...
    def retranslateUi(self, gestionnaires):
        ...
        item.setText(_translate("gestionnaires", "Nom d\'Utilisateur"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("gestionnaires", "Mot De Passe"))
        self.lineEditRechercher.setPlaceholderText(_translate("gestionnaires", "rechercher"))
...
if __name__ == "__main__":
    ...
    gestionnaires = QtWidgets.QWidget()
    ui = Ui_gestionnaires()
    ui.setupUi(gestionnaires)
    gestionnaires.show()
    sys.exit(app.exec_())
