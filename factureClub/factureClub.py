...
"")
        ...
        self.PrixTotal.setMinimumSize(QtCore.QSize(200, 30))
        self.PrixTotal.setMaximumSize(QtCore.QSize(200, 30))
...
"border-color: solid rgb(255, 255, 255);")
    ...
    def retranslateUi(self, membres):
        ...
        item.setText(_translate("membres", "Prix Unitaire (DA)"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("membres", "Quantité"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("membres", "Prix (DA)"))
