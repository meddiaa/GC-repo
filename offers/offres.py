...
# Form implementation generated from reading ui file '.\offres.ui'
#
...
class Ui_Offres(object):
    def setupUi(self, Offres):
        Offres.setObjectName("Offres")
        Offres.resize(1373, 576)
        Offres.setStyleSheet("background-color: rgb(210, 210, 210);")
        self.gridLayout = QtWidgets.QGridLayout(Offres)
        self.gridLayout.setObjectName("gridLayout")
        self.topheader = QtWidgets.QWidget(Offres)
...
"background-color:  rgb(210, 210, 210)")
        ...
        self.table = QtWidgets.QWidget(Offres)
        font = QtGui.QFont()
...
"")
        ...
        self.FilterButton = QtWidgets.QWidget(Offres)
