...
class Ui_ajouterAbonnement(object):
    def setupUi(self, ajouterAbonnement):
        ...
        self.Icon.setText("")
        self.Icon.setPixmap(QtGui.QPixmap(":/icons/add.png"))
...
"color: rgb(252, 252, 252);")
    ...
    def retranslateUi(self, ajouterAbonnement):
        ...
        self.LabelNom.setText(_translate("ajouterAbonnement", "Nom"))
        self.lineEditNom.setPlaceholderText(_translate("ajouterAbonnement", " Nom"))
        self.labelPrenom.setText(_translate("ajouterAbonnement", "Prénom"))
        self.lineEditPrenom.setPlaceholderText(_translate("ajouterAbonnement", "Prénom"))
        self.dropdownSport_2.setText(_translate("ajouterAbonnement", "Sport"))
        self.dropdownSport.setItemText(0, _translate("ajouterAbonnement", "Choisir"))
        self.LabelDateDebut.setText(_translate("ajouterAbonnement", "Date de début"))
        self.lineEditDateDebut.setPlaceholderText(_translate("ajouterAbonnement", "Date de début"))
        self.LabelDateFin.setText(_translate("ajouterAbonnement", "Date de fin"))
        self.lineEditDateFin.setPlaceholderText(_translate("ajouterAbonnement", "Date de fin"))
        self.LabelOffre.setText(_translate("ajouterAbonnement", "Offre"))
