...
"")
    ...
    def retranslateUi(self, MainWindowStats):
        ...
        self.comboBox.setItemText(1, _translate("MainWindowStats", "Karate_garçon"))
        self.comboBox.setItemText(2, _translate("MainWindowStats", "Karate_fille"))
        self.comboBox.setItemText(3, _translate("MainWindowStats", "Kick_-16"))
        self.comboBox.setItemText(4, _translate("MainWindowStats", "Kick_+16"))
        self.comboBox.setItemText(5, _translate("MainWindowStats", "Fitness_N-eddine"))
        self.comboBox.setItemText(6, _translate("MainWindowStats", "Fitness_femme"))
        self.comboBox.setItemText(7, _translate("MainWindowStats", "Fitness_hit"))
        self.comboBox.setItemText(8, _translate("MainWindowStats", "Kick_walid"))
        self.comboBox.setItemText(9, _translate("MainWindowStats", "Self_defense"))
        self.comboBox.setItemText(10, _translate("MainWindowStats", "Judo"))
